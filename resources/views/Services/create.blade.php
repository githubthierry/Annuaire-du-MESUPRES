...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header d-flex">
            <h2 class="modal-title" id="openlabel">Créer une service</h2>
            <button type="button" class="close d-block" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <div class="modal-body">
            <form action="{{ route('services.traitement') }}" method="POST">
                @csrf

                @include('Services._form',['submitButtonText' => 'Ajouter'])
