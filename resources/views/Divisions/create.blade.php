...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-header d-flex">
            <h2 class="modal-title" id="openlabel">Créer une division</h2>
        ...
        <div class="modal-body">
            <form action="{{ route('divisions.traitement') }}" method="POST">
                @csrf

                @include('Divisions._form',['submitButtonText' => 'ajouter'])
