...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-header d-flex">
            <h2 class="modal-title" id="openlabel">Créer une direction</h2>
        ...
        <div class="modal-body">
            <form action="{{ route('directions.traitement') }}" method="POST">
                @csrf
                @include('Directions._form',['submitButtonText'=>'Ajouter'])
            </form>
        </div>
